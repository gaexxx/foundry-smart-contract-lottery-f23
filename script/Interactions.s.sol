...
contract CreateSubscription is Script {
    // function that calls the subId using the vrfCoordinator address contained in HelperConfig
    ...
    // function that calls the subId using the vrfCoordinator address that we directly give (used in DeployRaffle.s.sol)
